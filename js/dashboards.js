...
(function () {
  ...
  // SUN TZU — versenytárs: TE vs ŐK oszlopok, egymással versengve
  ...
  // ATHÉNÉ — stratégia: döntési fa, egy ágon végigfutó impulzus
  ...
  // PERPETUUM — előfizetés: visszatérő bevétel-hurok, növekvő ív + körbefutó blip
  ...
  // MIDÁSZ — landoló szakértő: oldal-szekciók rajzolódnak sorban
  ...
  // ROBINSON — landoló építő: blokkok épülnek alulról fölfelé
  ...
  // KEPLER — hirdetéstervező: figyelem-tölcsér szűkül
  ...
  // CYRANO — szövegíró: hirdetésszöveg gépelődik, kurzorral
  ...
  // LEONARDO — kreatív designer: szín-swatchök + kivágó keret
  ...
  // VECTOR — képátméretező: egy master kreatív három natív képarányra rendeződik át
  ...
  // APOLLÓN — Google Ads: költségkeret-óra (gauge)
  ...
  // AURORA — Facebook Ads: célzó-reticle ráközelít a közönség-dotokra
  ...
  // HERMÉSZ — e-mail: boríték-szekvencia folyik lefelé, küldés-pulzus
  ...
  // MATISSE — Figma tervező: artboardok rendeződnek
  ...
  // NEXUS — Figma→kód: kódsorok jelennek meg, zárójelekkel
  ...
  // SENTRY — Figma QA: ellenőrző-lista pipálódik, pásztázó vonallal
  ...
  // GULLIVER — adatgyűjtő: lefelé áramló adat egy töltődő tárolóba
  ...
  // SEHEREZÁDÉ — script-író: forgatókönyv-sorok gépelődnek, jelenet-markerrel
  ...
  // GUTENBERG — renderelő: progress-bar + tile-ok komponálódnak
  ...
  // KRONOSZ — vágó: vágó-idővonal klipekkel + lejátszófej
  ...
  // VERITAS — SEO audit: státusz-pontos lista, pásztázó kiemelés
  ...
  // KOLUMBUSZ — kulcsszó: lebegő kulcsszó-pillék + nagyító
  ...
  // PARETO — tartalom-opt: pontszám-ív emelkedik + szöveg-sávok
  ...
  // MERIDIAN — technikai SEO: 3 mini CWV-mérő töltődik a jó tartományba
  ...
  // ARTEMISZ — helyi SEO: térkép-rács + lokáció-pin sonarral
  ...
  // FIGARO — LinkedIn specialista: kapcsolati háló épül a profil köré, outreach-impulzus fut a kapcsolatokon
  ...
  // ATLASZ — Csapatvezető: központi karmester, forgó diszpécser-sugár sorra bevonja a specialista-node-okat
