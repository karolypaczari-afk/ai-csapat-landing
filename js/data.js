...
(function () {
  ...
  window.GM_TEAM = [
    ...
    { cat: "Stratégia", catEn: "Strategy", color: "#7C3AED", members: [
      ...
      { code: "TYRION", role: "a versenytárs-elemző", roleEn: "the competitor analyst", slug: "genmarketer-competitor-intel", status: "live",
      ...
      { code: "JOHN", role: "a stratégiai partner", roleEn: "the strategic partner", slug: "genmarketer-billion-dollar-board", status: "live",
        ...
        proof: BG + "JOHN.webp", spec: { pipeline: "helyzet → opciók → döntés", cadence: "igény szerint", scheduler: "készen áll" },
        specEn: { pipeline: "situation → options → decision", cadence: "on demand", scheduler: "ready" } },
      { code: "GANDALF", role: "az előfizetések szakértője", roleEn: "the membership expert", slug: "genmarketer-membership-expert", status: "live",
    ...
    { cat: "Landoló oldal", catEn: "Landing page", color: "#06B6D4", members: [
      { code: "CLARK", role: "a landoló oldal szakértő", roleEn: "the landing page expert", slug: "genmarketer-landing-page-expert", status: "live",
      ...
      { code: "MAXIMUS", role: "a landoló oldal építő", roleEn: "the landing page builder", slug: "genmarketer-landing-page-builder", status: "soon",
    ...
    { cat: "Hirdetés", catEn: "Advertising", color: "#00D4FF", members: [
      { code: "DUMBLEDORE", role: "a hirdetéstervező", roleEn: "the ad planner", slug: "genmarketer-ad-planner", status: "live",
      ...
      { code: "JORDAN", role: "a hirdetés-szövegíró", roleEn: "the ad copywriter", slug: "genmarketer-ad-copywriter", status: "live",
      ...
      { code: "PAM", role: "a kreatív designer", roleEn: "the creative designer", slug: "genmarketer-ad-creative-design", status: "live",
      ...
      { code: "NEO", role: "a Facebook Ads-szakértő", roleEn: "the Facebook Ads expert", slug: "genmarketer-facebook-ad-expert", status: "live",
        ...
        proof: BG + "NEO.webp", spec: { pipeline: "célzás → kreatív → skálázás", cadence: "napi", scheduler: "folyamatos" },
        specEn: { pipeline: "targeting → creative → scale", cadence: "daily", scheduler: "continuous" } }
    ]},
    { cat: "E-mail", catEn: "Email", color: "#FFC400", members: [
      { code: "FORREST", role: "az e-mail-szakértő", roleEn: "the email expert", slug: "genmarketer-email-marketing-expert", status: "live",
    ...
    { cat: "Videó", catEn: "Video", color: "#400099", members: [
      ...
      { code: "TRUMAN", role: "az UGC-videó-producer", roleEn: "the UGC video producer", slug: "genmarketer-ugc-video", status: "live",
        ...
        proof: BG + "TRUMAN.webp", spec: { pipeline: "script → felvétel → vágás", cadence: "igény szerint", scheduler: "készen áll" },
        specEn: { pipeline: "script → shoot → edit", cadence: "on demand", scheduler: "ready" } },
      { code: "TED", role: "a videós script-író", roleEn: "the video script writer", slug: "genmarketer-video-script-writer", status: "live",
        ...
        proof: BG + "TED.webp", spec: { pipeline: "hook → ív → CTA", cadence: "igény szerint", scheduler: "készen áll" },
        specEn: { pipeline: "hook → arc → CTA", cadence: "on demand", scheduler: "ready" } },
      { code: "SARAH", role: "a videó-renderelő", roleEn: "the video renderer", slug: "seedance-multishot-prompter", status: "live",
    ...
    { cat: "SEO", catEn: "SEO", color: "#00AACC", members: [
      ...
      { code: "INDIANA", role: "a kulcsszó-kutató", roleEn: "the keyword researcher", slug: "genmarketer-seo-research", status: "live",
      ...
      { code: "MONICA", role: "a tartalom-optimalizáló", roleEn: "the content optimizer", slug: "genmarketer-seo-content", status: "live",
      ...
      { code: "DOKI", role: "a technikai SEO-szakértő", roleEn: "the technical SEO expert", slug: "genmarketer-seo-technical", status: "live",
      ...
      { code: "KATNISS", role: "a helyi SEO-szakértő", roleEn: "the local SEO expert", slug: "genmarketer-seo-local", status: "live",
